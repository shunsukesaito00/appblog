...
## Project-specific rules (appblog)

- Make the smallest sufficient change.
- Do not change unrelated code.
- Be concise.
- Do not provide ongoing status commentary.
- Do not explain implementation in long prose unless explicitly requested.
...
**Deploy:** `npm run build`; production URL `https://appblog-a4k.pages.dev`.
**Git remote:** `git@github-shunsukesaito00:shunsukesaito00/appblog.git` (SSH host alias).
